...
import com.abacus.poc295.cropcontrol.CropController;
...
public class CameraFragment extends Fragment
     ...
     *
     * @param file The message to show
     */
    ...
    private void cropImage(File file) {
        ...
        imagePath = saveToInternalStorage(result);
    ...
    private String saveToInternalStorage(Bitmap bitmapImage) {
        ...
        // Create imageDir
        File mypath = new File(directory, "poc.jpg");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCropControl = rootView.findViewById(R.id.crop_control);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        //mCropStatusTextView = view.findViewById(R.id.crop_status_text_view);
        //mCropControl = view.findViewById(R.id.crop_control);
    ...
    public void setupCropControl(View view) {
        //mCropStatusTextView.setText(R.string.start_dragging_crop);
        CropController cropController = new CropController(mCropControl, new CropController.TouchStateListener() {
            @Override
